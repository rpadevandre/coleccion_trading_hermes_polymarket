"""Pydantic API contracts for Med Spa Lead Recovery."""
...
class IntakeCreate(BaseModel):
    ...
    signals: dict[str, Any] = Field(default_factory=dict, description="Business-specific extracted fields: lead_source, treatment_interest, message, last_contacted_at, booking_status.")
    consent_for_followup: bool = False


class IntakeRecord(IntakeCreate):
    id: str = Field(default_factory=lambda: str(uuid4()))
    business_entity: str = "recovery_opportunity"
