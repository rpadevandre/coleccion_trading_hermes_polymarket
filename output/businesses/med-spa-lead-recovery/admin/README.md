# Med Spa Lead Recovery — Admin Panel Frontend

    This folder now contains a lightweight operator/admin panel prototype for **Med Spa Lead Recovery**.
    ...
    ```bash
    cd output/businesses/med-spa-lead-recovery/admin
