...
const viewMeta = frontendViews.find((view) => view.name === 'InactiveListAuditForm') ?? {
  name: 'InactiveListAuditForm',
  path: '/inactive-list-audit-form',
  description: 'Inactive list audit form.',
  primaryOutcome: 'Validate buyer demand and move qualified users into a pilot.'
};

export default function InactiveListAuditForm() {
  return (
