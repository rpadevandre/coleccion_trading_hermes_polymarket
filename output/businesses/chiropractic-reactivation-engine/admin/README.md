# Chiropractic Reactivation Engine — Admin Panel Frontend

    This folder now contains a lightweight operator/admin panel prototype for **Chiropractic Reactivation Engine**.
    ...
    ```bash
    cd output/businesses/chiropractic-reactivation-engine/admin
