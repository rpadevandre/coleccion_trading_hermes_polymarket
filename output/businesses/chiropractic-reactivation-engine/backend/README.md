# Chiropractic Reactivation Engine — FastAPI Backend

    This is the first executable backend scaffold for **Chiropractic Reactivation Engine**.
    ...
    ```bash
    cd output/businesses/chiropractic-reactivation-engine/backend
    python -m venv .venv
    . .venv/bin/activate
    ...
    ```text
    database: chiropractic_reactivation_engine
    ...
    - `PatientListImportService`
- `ReactivationSegmenter`
- `MessageDraftService`
- `OptOutSuppressionService`
- `RecoveredAppointmentTracker`
