"""Pydantic API contracts for Chiropractic Reactivation Engine."""
...
class IntakeCreate(BaseModel):
    ...
    signals: dict[str, Any] = Field(default_factory=dict, description="Business-specific extracted fields: last_visit_date, patient_status, preferred_channel, care_plan_stage, opt_out_status.")
    consent_for_followup: bool = False


class IntakeRecord(IntakeCreate):
    id: str = Field(default_factory=lambda: str(uuid4()))
    business_entity: str = "reactivation_candidate"
