"""Static contract tests for Chiropractic Reactivation Engine backend scaffold.
...
def test_business_specific_contract() -> None:
    ...
    assert "inactive_patient_segment" in meta
    assert "reactivation_candidate" in meta
