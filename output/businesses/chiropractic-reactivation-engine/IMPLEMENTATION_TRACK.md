# Implementation Track — Chiropractic Patient Reactivation Engine
...
Internal scaffold only inside `output/businesses/chiropractic-reactivation-engine`. No deploy, no production secrets, no GitHub split yet.
