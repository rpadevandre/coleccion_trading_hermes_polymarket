...
description: healthcare reactivation: trust, wellness, patient recall, calm clinical conversion.
colors:
  background: "#F8FAFC"
  surface: "#FFFFFF"
  surfaceAlt: "#EEF2F7"
...
Chiropractic Reactivation Engine should feel like a credible, revenue-oriented B2B SaaS validation product. Direction: healthcare reactivation: trust, wellness, patient recall, calm clinical conversion.

## Colors

- **Primary (#2563EB):** main CTA and active states.
- **Secondary (#0F766E):** navigation, headings, strong structure.
- **Accent (#16a34a):** conversion highlights, urgency, badges, metrics.
