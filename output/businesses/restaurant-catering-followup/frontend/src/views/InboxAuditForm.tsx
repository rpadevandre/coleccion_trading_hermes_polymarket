...
const viewMeta = frontendViews.find((view) => view.name === 'InboxAuditForm') ?? {
  name: 'InboxAuditForm',
  path: '/inbox-audit-form',
  description: 'Inbox workflow audit form.',
  primaryOutcome: 'Validate buyer demand and move qualified users into a pilot.'
};

export default function InboxAuditForm() {
  return (
