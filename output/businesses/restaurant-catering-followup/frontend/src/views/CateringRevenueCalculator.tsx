...
const viewMeta = frontendViews.find((view) => view.name === 'CateringRevenueCalculator') ?? {
  name: 'CateringRevenueCalculator',
  path: '/catering-revenue-calculator',
  description: 'Calculator for lost catering value.',
  primaryOutcome: 'Validate buyer demand and move qualified users into a pilot.'
};

export default function CateringRevenueCalculator() {
  return (
