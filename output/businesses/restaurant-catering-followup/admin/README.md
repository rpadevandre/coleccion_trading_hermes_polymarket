# Restaurant Catering Followup — Admin Panel Frontend

    This folder now contains a lightweight operator/admin panel prototype for **Restaurant Catering Followup**.
    ...
    ```bash
    cd output/businesses/restaurant-catering-followup/admin
