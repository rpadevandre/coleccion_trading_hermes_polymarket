...
const viewMeta = frontendViews.find((view) => view.name === 'ROICalculator') ?? {
  name: 'ROICalculator',
  path: '/r-o-i-calculator',
  description: 'Calculator for manager time saved and emergency leakage.',
