...
const viewMeta = frontendViews.find((view) => view.name === 'TenantRequestDemo') ?? {
  name: 'TenantRequestDemo',
  path: '/tenant-request-demo',
  description: 'Demo request intake and triage result.',
  primaryOutcome: 'Validate buyer demand and move qualified users into a pilot.'
};

export default function TenantRequestDemo() {
  return (
