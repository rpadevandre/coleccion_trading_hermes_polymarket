...
description: clean property operations: reliable triage, vendor routing, SLA visibility.
colors:
  background: "#F8FAFC"
  surface: "#FFFFFF"
  surfaceAlt: "#EEF2F7"
...
Property Maintenance Triage should feel like a credible, revenue-oriented B2B SaaS validation product. Direction: clean property operations: reliable triage, vendor routing, SLA visibility.

## Colors

- **Primary (#0F766E):** main CTA and active states.
- **Secondary (#334155):** navigation, headings, strong structure.
- **Accent (#059669):** conversion highlights, urgency, badges, metrics.
