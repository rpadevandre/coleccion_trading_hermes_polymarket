# Property Maintenance Triage — FastAPI Backend

    This is the first executable backend scaffold for **Property Maintenance Triage**.
    ...
    ```bash
    cd output/businesses/property-maintenance-triage/backend
    python -m venv .venv
    . .venv/bin/activate
    ...
    ```text
    database: property_maintenance_triage
    intakes: triage_ticket_intakes
    assessments: triage_ticket_assessments
