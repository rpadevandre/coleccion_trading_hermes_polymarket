"""Pydantic API contracts for Property Maintenance Triage."""
...
class IntakeCreate(BaseModel):
    ...
    signals: dict[str, Any] = Field(default_factory=dict, description="Business-specific extracted fields: unit_id, issue_category, photos_available, after_hours, tenant_message.")
    consent_for_followup: bool = False


class IntakeRecord(IntakeCreate):
    id: str = Field(default_factory=lambda: str(uuid4()))
    business_entity: str = "triage_ticket"
