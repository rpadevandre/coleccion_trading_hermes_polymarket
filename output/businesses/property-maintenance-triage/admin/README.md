# Property Maintenance Triage — Admin Panel Frontend

    This folder now contains a lightweight operator/admin panel prototype for **Property Maintenance Triage**.
    ...
    ```bash
    cd output/businesses/property-maintenance-triage/admin
