"""Pydantic API contracts for Construction Bid Inbox."""
...
class IntakeCreate(BaseModel):
    ...
    signals: dict[str, Any] = Field(default_factory=dict, description="Business-specific extracted fields: trade, deadline, project_location, scope_text, estimated_value.")
    consent_for_followup: bool = False


class IntakeRecord(IntakeCreate):
    id: str = Field(default_factory=lambda: str(uuid4()))
    business_entity: str = "bid_opportunity"
