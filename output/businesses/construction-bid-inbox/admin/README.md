# Construction Bid Inbox — Admin Panel Frontend

    This folder now contains a lightweight operator/admin panel prototype for **Construction Bid Inbox**.
    ...
    ```bash
    cd output/businesses/construction-bid-inbox/admin
