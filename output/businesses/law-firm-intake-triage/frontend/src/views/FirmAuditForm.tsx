...
const viewMeta = frontendViews.find((view) => view.name === 'FirmAuditForm') ?? {
  name: 'FirmAuditForm',
  path: '/firm-audit-form',
  description: 'Firm intake workflow audit form.',
  primaryOutcome: 'Validate buyer demand and move qualified users into a pilot.'
};

export default function FirmAuditForm() {
  return (
