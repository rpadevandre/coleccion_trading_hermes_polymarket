...
const viewMeta = frontendViews.find((view) => view.name === 'IntakeQualityCalculator') ?? {
  name: 'IntakeQualityCalculator',
  path: '/intake-quality-calculator',
  description: 'Calculator for staff/attorney time saved.',
  primaryOutcome: 'Validate buyer demand and move qualified users into a pilot.'
};

export default function IntakeQualityCalculator() {
  return (
