...
const viewMeta = frontendViews.find((view) => view.name === 'TranscriptUploadDemo') ?? {
  name: 'TranscriptUploadDemo',
  path: '/transcript-upload-demo',
  description: 'Transcript paste/upload demo.',
  primaryOutcome: 'Validate buyer demand and move qualified users into a pilot.'
};

export default function TranscriptUploadDemo() {
  return (
