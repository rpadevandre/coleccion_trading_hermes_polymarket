...
const viewMeta = frontendViews.find((view) => view.name === 'ContentCalendarPreview') ?? {
  name: 'ContentCalendarPreview',
  path: '/content-calendar-preview',
  description: 'Calendar preview page.',
