"""Pydantic API contracts for B2B Podcast Repurposing System."""
...
class IntakeCreate(BaseModel):
    ...
    signals: dict[str, Any] = Field(default_factory=dict, description="Business-specific extracted fields: episode_title, transcript_summary, target_channel, buyer_persona, campaign_goal.")
    consent_for_followup: bool = False


class IntakeRecord(IntakeCreate):
    id: str = Field(default_factory=lambda: str(uuid4()))
    business_entity: str = "repurposing_job"
