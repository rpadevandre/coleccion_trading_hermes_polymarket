# Implementation Track — B2B Podcast Repurposing System
...
Internal scaffold only inside `output/businesses/b2b-podcast-repurposing-system`. No deploy, no production secrets, no GitHub split yet.

## Domain

B2B founders / content teams
