# MSP Security Reporting — FastAPI Backend

    This is the first executable backend scaffold for **MSP Security Reporting**.
    ...
    ```bash
    cd output/businesses/msp-security-reporting/backend
    python -m venv .venv
    . .venv/bin/activate
    ...
    ```text
    database: msp_security_reporting
    intakes: client_report_case_intakes
    assessments: client_report_case_assessments
