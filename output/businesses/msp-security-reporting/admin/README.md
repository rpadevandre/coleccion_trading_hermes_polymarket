# MSP Security Reporting — Admin Panel Frontend

    This folder now contains a lightweight operator/admin panel prototype for **MSP Security Reporting**.
    ...
    ```bash
    cd output/businesses/msp-security-reporting/admin
