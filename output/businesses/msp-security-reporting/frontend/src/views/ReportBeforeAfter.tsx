...
const viewMeta = frontendViews.find((view) => view.name === 'ReportBeforeAfter') ?? {
  name: 'ReportBeforeAfter',
  path: '/report-before-after',
  description: 'Raw technical noise vs executive report.',
  primaryOutcome: 'Validate buyer demand and move qualified users into a pilot.'
};

export default function ReportBeforeAfter() {
  return (
