# HVAC Missed-Call Recovery — Admin Panel Frontend

    This folder now contains a lightweight operator/admin panel prototype for **HVAC Missed-Call Recovery**.
    ...
    ```bash
    cd output/businesses/hvac-missed-call-recovery/admin
