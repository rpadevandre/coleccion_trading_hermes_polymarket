# Implementation Track — HVAC Missed-Call Recovery
...
Internal scaffold only inside `output/businesses/hvac-missed-call-recovery`. No deploy, no production secrets, no GitHub split yet.

## Domain

HVAC emergency/service companies
