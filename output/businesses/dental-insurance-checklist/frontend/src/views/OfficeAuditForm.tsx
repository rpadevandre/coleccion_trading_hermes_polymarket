...
const viewMeta = frontendViews.find((view) => view.name === 'OfficeAuditForm') ?? {
  name: 'OfficeAuditForm',
  path: '/office-audit-form',
  description: 'Office workflow audit form.',
  primaryOutcome: 'Validate buyer demand and move qualified users into a pilot.'
};

export default function OfficeAuditForm() {
  return (
