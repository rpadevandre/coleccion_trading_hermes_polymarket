...
const viewMeta = frontendViews.find((view) => view.name === 'ReworkCalculator') ?? {
  name: 'ReworkCalculator',
  path: '/rework-calculator',
  description: 'Calculator for verification admin rework.',
  primaryOutcome: 'Validate buyer demand and move qualified users into a pilot.'
};

export default function ReworkCalculator() {
  return (
