# Implementation Track — Dental Insurance Checklist
...
Internal scaffold only inside `output/businesses/dental-insurance-checklist`. No deploy, no production secrets, no GitHub split yet.

## Domain

dental offices / insurance verification teams
