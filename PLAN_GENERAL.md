...
| Patrones de orquestación si el MVP escala | [`repos/DFZinc_JANUS.md`](repos/DFZinc_JANUS.md), `I_Built_the_Ultimate_Multi-Agent_Workflow_w_Hermes_Agent_Kan` (referencia citada en síntesis; archivo fuente no incluido en `videos/`) | Separación Hermes/Tyche con DBs independientes, patrón Kanban-SQLite como capa de coordinación — **solo si decides crecer más allá del MVP** |
